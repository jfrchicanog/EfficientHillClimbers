...
public class TwoStatesISArrayImplTest {
	...
	private void checkSameState(TwoStatesIntegerSet set1, TwoStatesIntegerSet set2)
	{
	...
	private void unexploredSequence(TwoStatesIntegerSet set, List<Integer> elements)
	{
		for (int i: elements)
		{
			set.unexplored(i);
	...
	private void checkUnexplored(TwoStatesIntegerSet set, List<Integer> unexplored)
	{
