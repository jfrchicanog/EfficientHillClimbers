...
public class RBallEfficientHillClimberSnapshot implements HillClimberSnapshot<EmbeddedLandscape> {
	...
	private final int radius; // This is just a convenient variable, since this value is used a lot
	...
	public RBallEfficientHillClimberSnapshot(RBallEfficientHillClimberForInstanceOf rballfio, PBSolution sol)
	{
	...
	private void initializeOperatorDependentStructures() {
		/* Sol */
		scores = new DoubleLinkedList[radius+1][2+((rball.quality_limits==null)?0:rball.quality_limits.length)];
	...
	private void initializeProblemDependentStructures()
	{
		...
		for (Map.Entry<SetOfVars, Integer> entry : rballfio.minimalPerfectHash.entrySet())
		{
