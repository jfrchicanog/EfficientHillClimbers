...
public class MaxSATHpInitExperiment implements Process {
	...
	public void execute(String[] args) {
		...
		// Check instance
		if (!UtilityMethods.checkOneValue(options, "i", "instance file"))
			return;
		// else
		...
		// Check the descents
		if (!UtilityMethods.checkOneValue(options, "d", "descents"))
			return;
		// else
