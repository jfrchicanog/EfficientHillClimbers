...
public class QualityBasedNonNeutralSelector extends AbstractMovesSelector implements MovesSelector {
    ...
    public QualityBasedNonNeutralSelector(RBallEfficientHillClimberSnapshot rBallSnapshot) {
        ...
        qualityLimits = rBallSnapshot.rball.qualityLimits;
