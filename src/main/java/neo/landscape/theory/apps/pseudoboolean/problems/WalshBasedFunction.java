...
public class WalshBasedFunction<W extends WalshCoefficientsInterface<W>> extends EmbeddedLandscape implements KBoundedEpistasisPBF {
    ...
    public void writeInstance(PrintWriter pw) {
        pw.println("c File automatically generated by WalshBasedFunction");
        pw.println("p "+n);
        for (int i = 0; i < m; i++) {
            ...
            sb.append(": ").append(wcsOriginal.getCoefficient(walshCoefficientIDs[i]));
