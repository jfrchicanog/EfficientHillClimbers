...
public class ParetoNonDominatedSet2D implements Iterable<double []>{
    ...
    public ParetoNonDominatedSet2D() {
    ...
    public static void combine(ParetoNonDominatedSet2D source1, double [] offset1, ParetoNonDominatedSet2D source2, double [] offset2, ParetoNonDominatedSet2D target) {
        target.clear();
    ...
    private static void moveToTarget(ParetoNonDominatedSet2D source, double[] offset, ParetoNonDominatedSet2D target) {
        for (double [] p : source.archive) {
            addWithOffset(p, offset, target);
        }
    }

    private static void addWithOffset(double[] p, double[] offset, ParetoNonDominatedSet2D target) {
