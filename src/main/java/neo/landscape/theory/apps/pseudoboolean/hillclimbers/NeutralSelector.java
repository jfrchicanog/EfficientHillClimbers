...
public class NeutralSelector extends AbstractMovesSelector implements MovesSelector {
    ...
    public NeutralSelector(RBallEfficientHillClimberSnapshot rBallSnapshot) {
        randomMoves = true;
        ...
        rnd = new Random(rBallSnapshot.rnd.nextLong());
        neutralMaxProbability = rBallSnapshot.rball.maxNeutralPrbability;
    }
    ...
    private MovesStore createMovesStore(int radius, int buckets, Map<SetOfVars, Integer> minimalPerfectHash, Random rnd) {
        ...
        return new ArrayBasedMovesStore(radius, buckets, minimalPerfectHash, seed, NEUTRAL_BUCKET);
    }
