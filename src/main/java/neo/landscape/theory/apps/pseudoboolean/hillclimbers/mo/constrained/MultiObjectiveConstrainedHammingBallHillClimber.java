...
public class MultiObjectiveConstrainedHammingBallHillClimber implements
	...
	public MultiObjectiveConstrainedHammingBallHillClimber(Properties prop) {
	...
	public MultiobjectiveHillClimberForInstanceOf<VectorMKLandscape> initialize(
		...
		return new MultiObjectiveConstrainedHammingBallHillClimberForInstanceOf(this, prob);
	}
