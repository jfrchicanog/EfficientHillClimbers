...
/**
 * This generator is based on the recursive algorithm of the Gang Li's Master
 * Thesis (University of Calgary). It generates all the rooted trees up to a
 * given number of nodes. The representation used is the parent vector and the
 * order in which they are generated is the relex order.
 * 
 * @author francis
 *
 */
...
public class RootedTreeGenerator {
	...
	public interface RootedTreeCallback {
		/**
		 * This method will be invoked by the generator when it has a tree. The
		 * array starts in 1 (the 0 position is not used).
		 * 
		 * @param par
		 *            the parent representation of the tree
		 * @param p
	...
	/**
	 * The name and parameters of this method are the same as in the original
	 * Pascal code of the procedure by Gang Li.
	 * 
	 * @param p
	 * @param s
	 * @param cL
	 ...
	 * 
	 * @param n
	 *            the maximum size of the trees.
	 * @param rtc
	 *            the callback object to inform of the Rooted Trees.
	 */
